...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "malvin~Jq9SRBja#tB73PQGy_n55RBjP6xFIvgKgBz_mfxtMos0nRU6Fy40",
...
// make true if you want auto reply on status 
        ...
        AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY DEATH DREAM ☠️⚰️*",
...
// automatic delete links witho remove member 
          ...
          OWNER_NUMBER: process.env.OWNER_NUMBER || "923376261188",
...
// true if want mark commands as read 
     ...
     DEV: process.env.DEV || "923376261188",
...
// change it to 'inbox/ same if you want to resend deleted message in same chat 
      ...
      AUTO_RECORDING: process.env.AUTO_RECORDING || "truee",
